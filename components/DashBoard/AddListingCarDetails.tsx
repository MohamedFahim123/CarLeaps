...
export default function AddListingCarDetails({ tab, handleTabChange, clearErrors, setValue, register, errors, watch, store }: TabProps) {
  ...
  return (
    <div className={`tab-pane fade ${tab === "car_details" ? "show active" : ""}`} id="car_details" role="tabpanel" aria-labelledby="car_details_tab">
      <div className="row">
        ...
        <div className="form-column col-lg-4 col-md-6">
          <InputField label="Engine Size" name="engine" register={register} errors={errors} type="text" placeholder="Enter Engine Size" />
        </div>
        <div className="form-column col-lg-4 col-md-6">
          <div className="form_boxes">
            ...
            <div className="right-box-four row gap-2">
                ...
                <div className="report-box col-lg-3 col-md-6 col-sm-12">
                  ...
                  <ul className="social-icon">
                    ...
                    <li>
                      ...
                      <input id={`addListing-history-upload2`} type="file" accept=".pdf,.doc,.docx" onChange={(e) => handleImageChange2(e)} style={{ display: "none" }} />
                    </li>
                  </ul>
                </div>
              )}
              <div className="uplode-box col-lg-3 col-md-6 col-sm-12">
                <div className="content-box">
                  ...
                  <input id="addListing-history-new-upload2" type="file" style={{ display: "none" }} onChange={(e) => handleImageChange2(e)} />
                </div>
              </div>
            </div>
