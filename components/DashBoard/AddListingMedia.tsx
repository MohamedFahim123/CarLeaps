          ...
          <div className="inner-box add-input-image">
            {images && (
              <div className="image-box">
                <Image width={190} height={167} src={images} alt={`Preview `} className="uploaded-img" />
                <div className="content-box">
                  <ul className="social-icon">
                    ...
                    <li>
                      <label style={{ cursor: "pointer" }} htmlFor={`file-upload-mainImage`}>
                        <a>
                          <Image width={18} height={18} src="/images/resource/delet1-1.svg" alt="Upload" />
                        </a>
                      </label>
                      <input id={`file-upload-mainImage`} type="file" accept="image/*" onChange={(e) => handleImageChange(e)} style={{ display: "none" }} />
                    </li>
                  </ul>
                </div>
              </div>
            ...
            {!images && (
              <div className="uplode-box">
                <div className="content-box">
                  ...
                  <input id="upload-new" type="file" accept="image/*" style={{ display: "none" }} onChange={(e) => handleImageChange(e)} />
                </div>
              </div>
            )}
          </div>
          ...
          <div className="form-column col-lg-12">
            <div className="inner-box">
              <div className="form_boxes">
                ...
                <input id="videoLink" placeholder="https://www.youtube.com/your_video_link" type="text" name="video_link" />
              </div>
