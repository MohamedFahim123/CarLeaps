...
export default function HeaderDashboard() {
  ...
  const handleFocus = () => {
    const boxContentSearch = document.getElementById("box-content-search");
    if (boxContentSearch) {
      boxContentSearch.classList.add("active");
      const layoutSearch = boxContentSearch.closest(".layout-search");
      if (layoutSearch) {
        layoutSearch.classList.add("active");
      }
    }
  };
  ...
  const handleBlur = () => {
    ...
    if (boxContentSearch) {
      ...
      const layoutSearch = boxContentSearch.closest(".layout-search");
      if (layoutSearch) {
        layoutSearch.classList.remove("active");
      }
    }
  };
