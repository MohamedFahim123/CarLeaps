...
export default function RelatedCars({ relatedCars }: { relatedCars: Car[] }) {
            ...
            >
              <div className="inner-box mx-2">
                ...
                <div className="content-box">
                  ...
                  <div className="text">{car?.description.slice(0, 30)}...</div>
                  ...
                  <ul className="d-flex gap-3">
                    <li style={{ height: "50px", width: "50px", margin: 0 }}>
                      <Image
