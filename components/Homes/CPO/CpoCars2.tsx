...
import { Car, useCarsForSaleStore } from "@/app/store/CarsForSale";
...
export default function CpoCars2({ cars }: { cars: Car[] }) {
  const { currentRegion } = useCarsForSaleStore();

  if (cars.length === 0) return null;

  return (
    <section className="cars-section-five border-1 border-white border-bottom">
          ...
          <div className="tab-pane fade show active">
            ...
            >
              {cars.map((car) => (
                ...
                >
                  <div className="inner-box bg-white mx-2 rounded-3 shadow-lg">
